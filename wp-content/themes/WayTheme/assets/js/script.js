...
//       $("#range-slider .ui-slider-handle:last-child").attr(
//         "data-max",
//         "p." + ui.values[1]
//       );
//     },
...
//   $("#range-slider .ui-slider-handle:last-child").attr("data-max", "p.257000");
//   // $("#amount").val(
//   //   "$" +
...
$(".category-item .sub-menu li").on("click", function () {
  $(this).toggleClass("active");
});
