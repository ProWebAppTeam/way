...
<?php
	...
	<div class="wrap-block">
       ...
       <main>
         ...
         <section class="content-block">
           <div class="container">
			...
			<?php
			$collection_name = get_post_field('collection_attribute_name',get_the_ID());
			...
			$args = array(
		        // Использование аргумента tax_query для установки параметров терминов таксономии 
		            ...
		            array(
		                  'taxonomy' => 'pa_collections',
		                  'field' => 'slug',
		                  'terms' => $collection_name
		                )
	                ),
     ...
     <div class="big-gallery">
         <?php 
            $gallery = carbon_get_post_meta($collectionPostId,'collection_gallery');
