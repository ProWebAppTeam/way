...
<form method="get" action="<?php echo esc_url($form_action); ?>">
    <div class="price_slider_wrapper">
        <div id="range-slider" class="price_slider" style="display:none;" data-min="<?php echo esc_attr($min_price); ?>" data-max="<?php echo esc_attr($max_price); ?>"></div>
        <div class="price_slider_amount" data-step="<?php echo esc_attr($step); ?>">
            ...
            <button type="submit" class="button" style="display:none"><?php echo esc_html__('Filter', 'woocommerce'); ?></button>
